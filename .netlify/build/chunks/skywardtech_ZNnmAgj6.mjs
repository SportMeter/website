const id = "en/skywardtech.mdoc";
						const collection = "works";
						const slug = "en/skywardtech";
						...
						const data = {title:"SkywardTech Solutions",pubDate:new Date(1709942400000),lastUpdateDate:new Date(1709942400000),cover:
						new Proxy({"src":"/_astro/cover.D_pWQcN_.jpg","width":1080,"height":1082,"format":"jpg","fsPath":"/Users/mauro/Dev/Ezzie/Website/src/assets/works/skywardtech/cover.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mauro/Dev/Ezzie/Website/src/assets/works/skywardtech/cover.jpg";
							}
							
							return target[name];
						}
					})
					,description:"Revolutionizing enterprise software interfaces through innovative design systems and cutting-edge user experience methodologies.",link:"https://skywardtech.io",tags:["Enterprise","UX/UI","Digital Transformation"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/mauro/Dev/Ezzie/Website/src/content/works/en/skywardtech.mdoc",
							rawData: "\ntitle: SkywardTech Solutions\nlink: https://skywardtech.io\ndescription: Revolutionizing enterprise software interfaces through innovative design systems and cutting-edge user experience methodologies.\ntags:\n  - Enterprise\n  - UX/UI\n  - Digital Transformation\ncover: '@/assets/works/skywardtech/cover.jpg'\npubDate: 2024-03-09\nlastUpdateDate: 2024-03-09",
						};
