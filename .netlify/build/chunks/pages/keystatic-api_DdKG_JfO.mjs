        ...
        contacts: fields.object(
          {
            ...
            socials: fields.array(
              ...
              {
                label: "Social",
                itemLabel: (props) => props.fields.title.value ?? "Stel een titel in"
              }
            )
          },
          {
      ...
      schema: {
        title: fields.slug({
          ...
          slug: {
            ...
            description: "Slug om te gebruiken voor de pagina, let op, het wordt afgeraden om deze te wijzigen na publicatie."
          }
        }),
        ...
        content: fields.markdoc({
          ...
          components: {
            Container: wrapper({
              ...
              description: "Container die je in staat stelt om marge toe te voegen aan de rechter- en linkerkant",
              schema: {
                class: fields.text({
            ...
            ContainerFluid: wrapper({
              ...
              description: "Container die je in staat stelt om marge te hebben aan de rechter- en linkerkant",
              schema: {
                class: fields.text({
                  label: "Aangepaste klassen"
                })
            ...
            Prose: wrapper({
              ...
              description: "Tekstcontainer, ideaal voor blogs of informatieve inhoud",
              schema: {
                class: fields.text({
                  label: "Aangepaste klassen"
                })
            ...
            Flex: wrapper({
              ...
              schema: {
                ...
                verticalAlign: fields.select({
                  ...
                  description: "Kies de verticale uitlijning van de container",
                  options: [
                ...
                horizontalAlign: fields.select({
                  ...
                  description: "Kies de horizontale uitlijning van de container",
                  options: [
                ...
                itemsAlignment: fields.select({
                  ...
                  description: "Kies de uitlijning van objecten binnen de container",
                  options: [
                ...
                wrap: fields.checkbox({
                  label: "Regel omslaan",
                  description: "Kies of de tekst naar een nieuwe regel moet gaan wanneer er geen ruimte meer is in de container",
                  defaultValue: false
                })
              }
            }),
    ...
    posts: collection({
      ...
      schema: {
        title: fields.slug({
          ...
          slug: {
            label: "SEO-friendly slug",
            description: "Slug om te gebruiken voor het bericht, let op, het wordt afgeraden om deze te wijzigen na publicatie."
          }
        }),
        description: fields.text({
          label: "Description",
    ...
    works: collection({
      ...
      schema: {
        title: fields.slug({
          ...
          slug: {
            label: "SEO-friendly slug",
            description: "Slug om te gebruiken voor het werk, let op, het wordt afgeraden om deze te wijzigen na publicatie."
          }
        }),
        link: fields.text({
          label: "Link",
